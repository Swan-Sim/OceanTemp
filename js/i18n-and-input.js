    ...
    const i18n = {
      ko: {
        ...
        swell: "너울",
        sec: "초",
        windKey: "▲ 위쪽 화살표 = 바람이 불어가는 방향, 숫자 = 풍속(m/s) · 색: 초록 <4 · 노랑 <8 · 주황 <12 · 빨강",
      ...
      en: {
        ...
        swell: "swell",
        sec: "s",
        windKey: "▲ Top arrows = where the wind blows to, number = speed (m/s) · green <4 · yellow <8 · orange <12 · red",
